...
const s_textId = '153928876';
const s_pageId = '30199866';
const s_replyId = '529549208';
const s_sheetId = '19AGM0ZNnMq3l25PxJxi7kfy8f1vluoI6U5JcVH8fLI0';

// The values below are necessary for accurate timestamps, I've filled it in with EST as an example
const s_timezone = -4; // Your personal timezone (Example: UTC-5:00 is -5 here, UTC+10:30 would be 10.5)
...
const s_maxLengthName = 25; // The max character length of a name
...
const s_widgetTitle = 'Let us know what you think!';
