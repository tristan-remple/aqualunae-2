const Cover = () => {
    ...
    return (
        <div id="cover">
            <img id="logo" src={require('../img/aqualunae-fade.png')} alt="A round logo depicting a silver full moon and a wave." />
            <div id="cover-info">
                <p>
                ...
                <div className="tech-row">
                    { skills.map(sk => <img key={sk} className="tech-icon" src={require(`../img/skills/${sk}.png`)} alt={`${sk} icon`} title={sk} />) }
                </div>
            </div>
        </div>
    )
